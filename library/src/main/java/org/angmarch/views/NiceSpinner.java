                ...
                if (popupWindow != null) {
                    ...
                    post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            popupWindow.setAnchorView(NiceSpinner.this);
                            popupWindow.show();
...
//            drawable = DrawableCompat.wrap(drawable).mutate();
    ...
    public <T> void attachDataSource(@NonNull List<T> list) {
        adapter = new NiceSpinnerAdapter<>(getContext(), list, textColor, backgroundDrawable, spinnerTextFormatter, horizontalAlignment);
        setAdapterInternal(adapter);
    }

    public void setAdapter(ListAdapter adapter) {
        this.adapter = new NiceSpinnerAdapterWrapper(getContext(), adapter, textColor, backgroundDrawable,
